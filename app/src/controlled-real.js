...
async function createDisposableProbe(input={}) {
  ...
  const manifest={version:'03.1-A',marker:common.PROBE_MARKER,token:p.token,createdAt:new Date().toISOString(),probeLatitude:p.latitude,probeLongitude:p.longitude,coreResources:[],entities:{},relations:{},nonResourceRows:{}};
